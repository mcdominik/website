...
To szybki przewodnik wyjaśniający, jak uruchomić model uczenia maszynowego na Arduino przy użyciu TensorflowLite/LiteRT. W tym przypadku uruchamiam model rozpoznawania głosu na Arduino Nano 33 BLE Sense.

## Przegląd

Jak uruchomić model uczenia maszynowego na Arduino przy użyciu TensorflowLite/LiteRT.
...
Brak wymaganej konfiguracji. Fragmenty kodu dostępne w opisie wideo.

## Podsumowanie

Działający POC (Proof of Concept) uruchomienia modelu uczenia maszynowego na Arduino.

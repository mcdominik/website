...
To szybki przewodnik wyjaśniający różne modele Raspberry Pi i ich cechy.

## Przegląd

Zrozum różnice między różnymi modelami Raspberry Pi w zaledwie 5 minut.
Ten film omawia następujące tematy:

00:00 Wstęp
00:31 Seria Raspberry Pi Classic
2:18 Seria Raspberry Pi Zero
3:26 Seria Raspberry Pi Pico
4:39 Seria Raspberry Pi Compute Module
5:16 Zakończenie

## Wybór odpowiedniej płytki

Dowiedz się, który model Raspberry Pi jest najlepszy dla Twojego projektu.
